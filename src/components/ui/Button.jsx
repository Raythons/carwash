  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 cursor-pointer",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-input bg-background dark:bg-zinc-900/50 dark:border-zinc-800 dark:hover:bg-zinc-800 hover:bg-accent hover:text-accent-foreground dark:text-zinc-100 dark:hover:text-white transition-all duration-200 shadow-sm hover:shadow-md",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80",
        ghost: "hover:bg-accent dark:hover:bg-zinc-800 hover:text-accent-foreground dark:text-zinc-100 dark:hover:text-white transition-all duration-200",
